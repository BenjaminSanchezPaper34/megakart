...
export const RACES: Operation[] = [
  {
    ...
    name: "Les 100 Tours",
    accent: "race",
    summary: "Endurance adulte en relais sur les nouveaux Sodi RT10 390cc : équipes de 2 ou 3 pilotes, 100 tours au compteur.",
    details: [
    ...
    endsAt: "15h30",
    priceValue: 59,
    priceNote: "en équipe de 3 — 88€ en équipe de 2",
    reservation: true,
